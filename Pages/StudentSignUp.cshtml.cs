...
namespace FLEXX.Pages
{
    public class StudentSignUpModel : PageModel
    {
        ...
        public StudentSignUpModel(IConfiguration configuration)
        {
        ...
        public IActionResult OnPost()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                conn.Open();
                SqlCommand cmd;
                string query = "Insert into users values(@RollNumber,@Password,@First_Name,@Last_Name, 'S')";
                ...
                try
                {
                    ...
                    if (rowsAffected > 0)
                    {
                        ...
                        return RedirectToPage("/StudentLogin"); // Redirect to login page or any other page you'd like
                    }
                    else
                    {
                        // Insertion failed
